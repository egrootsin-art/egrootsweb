...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section - ✅ FIXED: Better mobile spacing and text sizing */}
      ...
      {/* Our Story - ✅ FIXED: Image height, mobile-first layout */}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              {/* ✅ FIXED: Better mobile badge spacing */}
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <Badge variant="secondary" className="text-xs sm:text-sm px-3 py-1">500+ Products</Badge>
                <Badge variant="secondary" className="text-xs sm:text-sm px-3 py-1">10,000+ Students</Badge>
                <Badge variant="secondary" className="text-xs sm:text-sm px-3 py-1">50+ Countries</Badge>
              </div>
            </div>
            
            {/* ✅ FIXED: Responsive image sizing, better mobile display */}
      ...
      {/* Mission & Vision - ✅ FIXED: Better mobile card padding */}
      ...
      {/* Our Values - ✅ FIXED: Better mobile grid, improved spacing */}
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          {/* ✅ FIXED: Mobile-first grid (1 col on mobile, 2 on tablet, 4 on desktop) */}
            ...
            {values.map((value, index) => (
              <Card key={value.title} className="gradient-card border-border/50 text-center tech-hover">
                <CardContent className="p-5 sm:p-6">
                  ...
                  <h3 className="font-semibold text-base sm:text-lg text-foreground mb-2">{value.title}</h3>
      ...
      {/* Team - ✅ FIXED: Better mobile card layout */}
      <section className="py-12 sm:py-16 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 sm:mb-4">
              ...
              <Card key={member.name} className="gradient-card border-border/50 tech-hover">
                <CardContent className="p-5 sm:p-6 text-center">
                  <img 
                    src={member.image} 
                    alt={member.name}
                    className="w-20 h-20 sm:w-24 sm:h-24 rounded-full mx-auto mb-3 sm:mb-4 object-cover border-4 border-primary/20"
                  />
                  <h3 className="font-semibold text-base sm:text-lg text-foreground mb-1">{member.name}</h3>
